...
const ru: Dict = {
  ...
  guide: 'Справка',
  aiTrader: 'AI Trader',
  aiTraderHelp: 'Отдельная prompt-driven стратегия: оператор выбирает счёт, инструмент и инструкцию. Это не SMA/Level/ORB instance. Сейчас доступны только observe/paper без real orders.',
...
const en: Dict = {
  ...
  guide: 'Guide',
  aiTrader: 'AI Trader',
  aiTraderHelp: 'Separate prompt-driven strategy: the operator selects account, instrument, and instruction. This is not an SMA/Level/ORB instance. Only observe/paper without real orders are available now.',
