...
const ru: Dict = {
  ...
  guide: 'Справка',
  aiTrader: 'AI Trader',
  aiTraderHelp: 'Агент наблюдает стакан и ленту в фоне (данные не показываются). В интерфейсе — только поток выводов и настройки сессии.',
...
const en: Dict = {
  ...
  guide: 'Guide',
  aiTrader: 'AI Trader',
  aiTraderHelp: 'The agent watches the book and tape in the background (not shown in UI). You only see the thought stream and session settings.',
